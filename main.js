...
this.wordle.bundle = function(e) {
    ...
    function Pa(e) {
        var a, s = Na(e);
        a = Math.floor(Math.random() * (Aa.length - 0 + 1)) + 0;
        return Aa[a];
    }
    function Na(e) {
        return $a(Ra, e)
